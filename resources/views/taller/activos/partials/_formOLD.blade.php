{{-- 
    Este partial requiere la siguiente variable:
    $activo: Objeto Activo (para bindear datos en la edición o un objeto vacío en la creación)
--}}
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            <label for="lectura_actual">Lectura Actual (<span id="unidad_label">{{ old('unidad_medida', $activo->unidad_medida ?? 'KM/HRS') }}</span>) <span class="text-danger">*</span></label>
            <input type="number" 
                   name="lectura_actual" 
                   id="lectura_actual" 
            ...
            <select name="estado_operativo" 
                ...
                @foreach ($estados_operativos as $estado)
                    <option value="{{ $estado }}" 
                            ...
                            {{-- Solo Operativo debe ser seleccionable por defecto en creación --}}
