...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.select2-agro').select2({ theme: 'default', width: '100%' });
    ...
    function toggleRecursoView(tipo) {
        ...
        if(tipo === 'maquinaria') {
            $('#block_manual').hide();
            $('#block_maquinaria').fadeIn();
        } else {
            $('#block_maquinaria').hide();
            $('#block_manual').fadeIn();
        }
    }
    ...
    function toggleContratista() {
        ...
        if (val === 'outsourcing') {
            ...
            $('#contratista_id').prop("required", true);
        } else {
            $('#div_contratista').slideUp();
            $('#contratista_id').prop("required", false).val('').trigger('change');
        }
    }
    ...
    function addMaquinariaRow() {
        ...
        $('.select2-dinamico').last().prev().select2({ theme: 'bootstrap4', width: '100%' }); // El primero de la fila
        $('.select2-dinamico').last().select2({ theme: 'bootstrap4', width: '100%' }); // El segundo de la fila
    }
